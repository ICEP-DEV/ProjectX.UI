          ...
          <div className="col-md-3 mb-4">
            <div className="card text-start h-100 custom-card">
              <div className="card-body">
                ...
                <p><strong>Closing Date:</strong> 25 November 2024</p>
              </div>
            </div>
          </div>
          <div className="col-md-3 mb-4">
            <div className="card text-start h-100 custom-card">
              <div className="card-body">
                ...
                <p><strong>Closing Date:</strong> 15 December 2024</p>
              </div>
            </div>
          </div>
          <div className="col-md-3 mb-4">
            <div className="card text-start h-100 custom-card">
              <div className="card-body">
                ...
                <p><strong>Closing Date:</strong> 5 January 2025</p>
              </div>
            </div>
          </div>
          <div className="col-md-3 mb-4">
            <div className="card text-start h-100 custom-card">
              <div className="card-body">
                ...
                <p><strong>Closing Date:</strong> 10 February 2025</p>
              </div>
            </div>
          </div>
        </div>
